...
export default function Contact(props) {
  ...
  return (
    <Flex
      ...
      ref={props.refernce}
      width='100%'
      direction={isNotSmallerScreen && isNotmediumScreen ? 'row' : 'column'}
      ...
      <VStack width={isNotSmallerScreen && isNotmediumScreen ? '50%' : '100%'}>
        ...
        >
          ...
          <Flex
            ...
            <InputGroup
              width={isNotSmallerScreen ? '49%' : '100%'}
              p='2'
              alignSelf='center'>
              <Input
                focusBorderColor=''
                ...
                type='text'
                placeholder='Name'
                _placeholder={{ color: isDark ? 'white' : 'black' }}
                width='100%'
                size='lg'
              />
            </InputGroup>
            ...
            <InputGroup
              width={isNotSmallerScreen ? '98%' : '100%'}
              p='2'
              alignSelf='center'>
              <Input
                focusBorderColor=''
            ...
            <Textarea
              ...
              placeholder='Message'
              _placeholder={{ color: isDark ? 'white' : 'black' }}
              width={isNotSmallerScreen ? '96.5%' : '97.5%'}
            ...
            <Flex width='100%' direction='row' justify='center'>
              <Icon
                ...
                h={isNotSmallerScreen ? '40px' : '30px'}
                margin={
                  isNotSmallerScreen ? (isNotmediumScreen ? '10' : '6') : '4'
                }
                onClick={() =>
                  (window.location.href = 'https://github.com/PrajwalR7')
                }
                as={FaGithub}
              />
              <Icon
                ...
                onClick={() =>
                  (window.location.href =
                    'https://www.linkedin.com/in/prajwal-ramesh-918a84187/')
                }
                as={FaLinkedin}
              />
              <Icon
                ...
                onClick={() =>
                  (window.location.href =
                    'https://stackoverflow.com/users/16412216/prajwal-ramesh')
                }
                as={FaStackOverflow}
              />
              <Icon
      ...
      <MotionBox
        ...
        <MapContainer center={[12.97, 77.59]} zoom={10} scrollWheelZoom={false}>
          <TileLayer
